...
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.DATE_NOT_PRESENT_ERROR;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.INVALID_DATE_ERROR;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.INVALID_ISBN;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.INVALID_ISSN;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.INVALID_TYPE;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.JOURNAL_NOT_IN_CHANNEL_REGISTER;
import static no.sikt.nva.brage.migration.common.model.record.ErrorDetails.Error.PUBLISHER_NOT_IN_CHANNEL_REGISTER;
